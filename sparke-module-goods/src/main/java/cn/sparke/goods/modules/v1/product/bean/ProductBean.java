package cn.sparke.goods.modules.v1.product.bean;
...
public class ProductBean extends BaseEntity{
    ...
    public Date getLimitStartime() {
        return limitStartime;
    }

    public void setLimitStartime(Date limitStartime) {
        this.limitStartime = limitStartime;
    }
